class GenerateRpzJob < ApplicationJob
  ...
  def perform(*args)
    ...
    #   list_domain = domain.list_domain
    #   action = domain.action

    #   #add condition if the list_domain is an arrays
    #   if list_domain.is_a?(Array)
    #     list_domains = JSON.parse(domain.list_domain)
    #   else
    #     list_domains = [domain.list_domain]
    #   end
