...
class SourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create source" do
    assert_difference("Source.count") do
      post sources_url, params: { source: { description: @source.description, name: @source.name } }
    end
  ...
  test "should update source" do
    patch source_url(@source), params: { source: { description: @source.description, name: @source.name } }
